...
@section('title')
    {!! trans('system.action.edit') !!} - {!! trans('steps.label') !!}
@stop
...
@section('content')
    ...
    @endif
    {!! Form::open(array('url' => route('admin.steps.update', $steps->id), 'method' => 'PUT', 'role' => 'form', 'files' => true )) !!}
        ...
        <table class='table borderless'>
            <tr>
                ...
                <td>
                    {!! Form::text('title', old('title', $steps->title), array('class' => 'form-control', 'required', 'maxlength' => 100)) !!}
                </td>
            </tr>
            <tr>
                <th class="text-right">
                ...
                <td>
                    {!! Form::textarea('content', old('content', $steps->content), array('class' => 'form-control', 'rows' => 3, 'required',  'maxlength' => 255)) !!}
                </td>
            </tr>
            <tr>
                <th class="text-right">
                ...
                <td>
                    {!! Form::text('icon', old('icon', $steps->icon), array('class' => 'form-control', 'required', 'maxlength' => 50)) !!}
                </td>
            </tr>
            <tr>
                <td class="text-center" colspan="4">
                    {!! trans('system.status.active') !!}
                    {!! Form::checkbox('status', 1, old('status', $steps->status), [ 'class' => 'minimal-red' ]) !!}
                </td>
            </tr>
            <tr>
